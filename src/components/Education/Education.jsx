...
//           >
//             {/* Timeline Circle */}
//             <div className="absolute left-0 sm:left-1/2  sm:-translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
//               <img
//                 src={edu.img}
//                 alt={edu.school}
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            <div
              ...
              sm:ml-44 sm:mr-44 ml-16 transform transition-transform duration-300 hover:scale-105`}
            >
              <div className="flex items-center space-x-6">
                <div className="w-24 h-16 bg-white rounded-md overflow-hidden">
                  <img
