...
//                     className="w-1/2 bg-purple-800 hover:bg-purple-950 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center"
//                   >
//                     View Code
//                   </a>
//                   {/* <a
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-gray-500 mb-3 text-sm md:text-base line-clamp-3">
                {project.description}
              </p>
